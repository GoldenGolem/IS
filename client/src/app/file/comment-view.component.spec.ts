...
describe('CommentViewComponent', () => {
  ...
  describe('#deleteComment()', () => {
    ...
    it('calls fileService delete method with comment', () => {
      spyOn(fileService, 'deleteComment').and.callThrough();
      component.deleteComment();
      expect(fileService.deleteComment).toHaveBeenCalledWith(component.comment);
    });
